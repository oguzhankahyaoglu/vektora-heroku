...
namespace WebApplication1.Application
{
    ...
    {
        [DebuggerStepThrough]
        public static TResult CallVenüsBayi<TResult>(Func<BayiServices.ServiceClient, Task<TResult>> callMethod)
        {
            return DebugExec<BayiServices.ServiceClient, BayiServices.IService, TResult>(callMethod);
        }

        public static BayiServices.AuthInfo AuthToken => new BayiServices.AuthInfo { Username = "123", Password = "456" };
